...
#+begin_src sql :post wrap_table.py(data=*this*)
SELECT * FROM unique_titles
LIMIT 5;
#+end_src
...
#+begin_export html
<table><tr><th>files</th></tr><tr><td>__pycache__</td></tr><tr><td>headers.setup</td></tr><tr><td>pow.html</td></tr><tr><td>pow.org</td></tr><tr><td>pow.py</td></tr><tr><td>tangled</td></tr><tr><td>the_best_fare_per_driver.png</td></tr><tr><td>theme-readtheorg-local.setup</td></tr></table>
#+end_export
