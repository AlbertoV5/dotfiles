...
((identifier) @constant.builtin
 (.match? @constant.builtin "^(arguments|module|console|window|document)$")
 (.is-not? local))
...
[(this) (super) (true) (false) (undefined) (null)] @variable.builtin
((identifier) @variable.builtin
 (.match? @variable.builtin "^(NaN|Infinity|globalThis)"))
